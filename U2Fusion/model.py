...
class Model(object):
	def __init__(self, BATCH_SIZE, is_training=False):
		...
		self.SOURCE1 = tf.placeholder(tf.float32, shape = (BATCH_SIZE, None, None, 1), name = 'SOURCE1')
		self.SOURCE2 = tf.placeholder(tf.float32, shape = (BATCH_SIZE, None, None, 1), name = 'SOURCE2')
