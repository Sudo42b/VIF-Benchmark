...
import sys
import os
IRNNForward = open(os.path.abspath(__file__).replace('irnn.py','')+'IRNN_Forward_cuda.cu','r').read()
IRNNBackward = open(os.path.abspath(__file__).replace('irnn.py','')+'IRNN_Backward_cuda.cu','r').read()
